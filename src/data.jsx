...
export const data = [
    ...
    {
        id: 2,        
        hotel: "Milestrelles (Cornellà del Terri)",
    ...
    {
        id: 3,        
        hotel: "Iglú de las Estrellas (Xalet de Prades)",
    ...
    {
        id: 8,        
        hotel: "Yurta Mongola (Delta de l’Ebre)",
    ...
    {
        id: 9,        
        hotel: "Mastinell Cava & Boutique Hotel (Vilafranca del Penedès)",
    ...
    {
        id: 12,        
        hotel: "El Recer de Masia Serra (Cantallops)",
